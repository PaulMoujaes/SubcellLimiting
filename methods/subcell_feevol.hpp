...
public:
   ...
   virtual void BuildSubcellDivElementMatrix2(const int e, const DenseMatrix & Ce, SparseMatrix &Ce_tilde) const;
   virtual void AdjustSubcellElementMatrix(const DenseMatrix &Ce, SparseMatrix &Ce_tilde) const;
